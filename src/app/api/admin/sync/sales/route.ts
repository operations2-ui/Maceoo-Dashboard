...
// Sales' own budget, independent of inventory/retail audit — see the note
// in src/lib/sync.ts on why the three phases were split into separate
// invocations (Vercel Hobby's 300s ceiling). This is the heaviest phase now
// that the sheet is line-item grain, so the one most likely to need it.
