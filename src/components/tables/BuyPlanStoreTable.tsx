          ...
          <tr>
            {columns.map((c) => (
              <th
                ...
                title={c.title}
                className={`${c.numeric ? "px-3" : "px-3"} py-2 text-left font-semibold text-slate-600 dark:text-slate-300 bg-slate-50 dark:bg-slate-800 cursor-pointer select-none hover:bg-slate-100 dark:hover:bg-slate-700 whitespace-nowrap`}
              >
                {c.header}
